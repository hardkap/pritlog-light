...
The idea of this blog, is directly taken from a very simple yet powerful blog software called PPLOG (Perl Powered Blog). PPLOG is a creation of Federico Ramírez (fedekun) - fedekiller@gmail.com. I just wanted to experiment with creating a similar blog in PHP. Hence PRITLOG.		   
...
h2. Changes for 0.411

h3. Pritlog 0.411 (Fixes the following things - still in testing)
